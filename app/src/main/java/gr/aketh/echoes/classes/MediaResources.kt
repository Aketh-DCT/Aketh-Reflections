...
object MediaResources {
    //This object is dedicated to having the images and sounds set, so we can find them easily
    //Intro images
    val introImage = mapOf(
